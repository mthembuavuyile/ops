...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-[#FAF9F5] text-[#2E2D27] font-sans">
      ...
      <main className="flex-grow p-6 md:p-10 overflow-y-auto max-w-full">
          ...
          <div className="space-y-8 animate-fadeIn">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white border border-[#DCDBCF] rounded-none p-5 flex flex-col justify-between">
                <div>
                  <h3 className="font-bold text-[#111111] text-sm uppercase tracking-wider">Active Accounts</h3>
                  <p className="text-[#8E8C82] text-[10px] font-mono mt-1">Configured ZAR invoicing targets.</p>
            ...
            <div className="bg-white border border-[#DCDBCF] p-6 md:p-8 rounded-none">
              <form onSubmit={handleQuoteSubmit} className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div>
                    <label className="block text-[9px] font-mono font-bold uppercase tracking-wider text-slate-500 mb-2">Select Client</label>
                    <select 
          ...
          <div className="space-y-8 animate-fadeIn">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              <div className="lg:col-span-7 flex flex-col gap-4">
                <div className="flex justify-between items-center bg-[#1E1D19] text-white rounded-none p-4 border border-[#2C2B25]">
        ...
        {activeView === "client" && (
          <div className="space-y-8 animate-fadeIn">
            ...
            <div className="bg-[#FAF9F5] text-slate-900 p-5 rounded-none border border-[#DCDBCF] flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              <div>
                <h2 className="font-bold text-xs uppercase font-mono tracking-wider">
                  Client Simulator Sandbox
                </h2>
                <p className="text-[10px] text-slate-500 font-mono mt-0.5">
                  Simulating what your client sees when opening a WhatsApp link or proposal invitation.
                </p>
              </div>
              <div className="flex gap-2 items-center w-full md:w-auto text-xs font-mono">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                  ...
                  <div className="lg:col-span-8 flex flex-col gap-6">
                    <div 
                      ...
                      className="bg-white border border-[#DCDBCF] rounded-none p-8 md:p-12 relative font-sans shadow-none"
                    ...
                    >
                      <div className="flex justify-between items-start">
                        ...
                        <div className="text-right">
                          ...
                          <span className="font-mono text-xs font-bold text-slate-400 font-bold">
                          ...
                          <span className={`block mt-2 font-mono text-[9px] font-bold uppercase px-2.5 py-0.5 border rounded-none w-fit ml-auto ${
                            isAccepted 
                              ? (invoice?.status === "paid" ? "bg-emerald-50 text-emerald-800 border-emerald-200" : "bg-amber-50 text-amber-800 border-amber-200")
                              : "bg-sky-50 text-sky-800 border-sky-200"
                          }`}>
                            {isAccepted ? (invoice?.status === "paid" ? "Paid" : "Awaiting EFT") : "Proposal Active"}
                          </span>
                        </div>
                      </div>
                    ...
                    {!isAccepted ? (
                      <div className="bg-white border border-[#DCDBCF] p-6 space-y-4 rounded-none">
                        ...
                        <button 
                          ...
                          className="w-full bg-[#111111] hover:bg-[#252525] text-white font-mono font-bold uppercase tracking-wider py-3.5 text-xs rounded-none transition"
                        >
                          Confirm Acceptance
                        </button>
                      </div>
